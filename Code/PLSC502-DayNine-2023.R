...
temp <- tempfile()
download.file("http://scdb.wustl.edu/_brickFiles/2022_01/SCDB_2022_01_caseCentered_Docket.csv.zip",temp)
df <- read.csv(unz(temp, "SCDB_2022_01_caseCentered_Docket.csv"))
unlink(temp)
...
pdf("PropSimN20-95-R-23.pdf",6,5)
par(mar=c(4,4,2,2))
...
pdf("PropSimN100-95-R-23.pdf",6,5)
par(mar=c(4,4,2,2))
...
pdf("PropSimN400-95-R-23.pdf",6,5)
par(mar=c(4,4,2,2))
...
data<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC502-2023-git/master/Exercises/PLSC502-2023-ExerciseFour.csv")
