...
# Load a package or two (you might need to install one or more of
...
WB<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC502-2023-git/master/Data/WarrenBurger.csv")
