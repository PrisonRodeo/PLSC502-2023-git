...
DH<-as.data.frame(read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC502-2023-git/master/Data/DH.csv"))
...
Clerks<-as.data.frame(read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC502-2023-git/master/Data/annualclerks.csv"))
...
Panel<-as.data.frame(read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC502-2023-git/master/Data/Assass.csv"))
...
Dyads<-as.data.frame(read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC502-2023-git/master/Data/dyads1968.csv"))
